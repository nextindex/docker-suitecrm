...
The [full Github project](https://github.com/nextindex/docker-suitecrm/) defines a Docker Compose environment which runs SuiteCRM in one container and a MySQL instance in another. To set up SuiteCRM using this approach, please do the following:
